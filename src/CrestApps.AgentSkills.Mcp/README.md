...
For Orchard Core–specific skills, see the companion package [`CrestApps.AgentSkills.Mcp.OrchardCore`](../CrestApps.AgentSkills.Mcp.OrchardCore/README.md), which builds on top of this project and bundles both the framework-only Orchard Core skills and the CrestApps OrchardCore module skills.
