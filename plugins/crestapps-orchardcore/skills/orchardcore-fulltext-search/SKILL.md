...
description: Skill for implementing full-text search in Orchard Core. Covers enabling search features, index creation and configuration, analyzer setup, search settings, permissions, custom full-text indexing with Liquid, search template customization, and FlowPart widget indexing.
---
